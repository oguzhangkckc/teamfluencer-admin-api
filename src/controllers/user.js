...
exports.getverificationprofiles = async (req, res) => {
  ...
  try {
    ...
    if (req.query.min_tiktok_average_likes && req.query.max_tiktok_average_likes) {
      filter['tiktok.tiktok_average_likes'] = {
        $gte: req.query.min_tiktok_average_likes,
        $lte: req.query.max_tiktok_average_likes,
      };
    ...
    if (req.query.min_tiktok_engagement_rate && req.query.max_tiktok_engagement_rate) {
      filter['tiktok.tiktok_engagement_rate'] = {
        $gte: req.query.min_tiktok_engagement_rate,
        $lte: req.query.max_tiktok_engagement_rate,
      };
